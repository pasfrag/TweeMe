...
from demo_req import get_timeline_of_user
import pickle
import pandas as pd
...
# tweets = get_timeline_of_user('@fchollet')
# pickle.dump(tweets,open('tweets','wb'))
# rts = get_retweets(tweets)
# pickle.dump(rts,open('retweets','wb'))
# rts = pickle.load(open('retweets','rb'))
# ff = get_all_friend_features(rts)
# print (ff)
# print (len(ff))
# pickle.dump(ff,open('friendfeatures','wb'))
# ff = pickle.load(open('friendfeatures','rb'))
# #
# print (get_unique_retweets_rate(ff))
# print (get_num_of_distinct_languages(ff))
# print (get_account_age_distribution(ff))
# print (get_number_of_followers_distribution(ff))
# print (get_number_of_friends_distribution(ff))
# print (get_number_of_lists_distribution(ff))
# print (get_number_of_statuses_distribution(ff))
# print (get_number_of_favourites_distribution(ff))
# print (get_description_length_distribution(ff))
# print (get_fraction_of_users_with_urls(ff))
# print (get_fraction_of_users_with_default_image(ff))
# print (get_fraction_of_users_with_default_profile(ff))
# print (get_fraction_of_unique_profile_descriptions(ff))

...
def get_user_vector(user):
	...
	# lista = list(user_vector.keys())
	# pickle.dump(lista, open('../user_features', 'wb'))
	return user_vector
...
def get_friend_feature_vector(tweets):
	...
	# lista = list(friends_vector.keys())
	# pickle.dump(lista, open('../friend_features', 'wb'))
...
def get_temporal_features_vector(tweets):
	...
	# lista = list(temporal_features_vector.keys())
	# pickle.dump(lista, open('../temporal_features', 'wb'))
...
def get_temporal_features_vector_only_twts(tweets):
	...
	lista = list(temporal_features_vector.keys())
	pickle.dump(lista, open('../temporal_features_twts', 'wb'))
	return temporal_features_vector
...
def get_content_feature_vector(tweets):
	...
	# lista = list(content_vector.keys())
	# pickle.dump(lista, open('../content_features', 'wb'))
...
def get_sentiment_feature_vector(tweets):
	...
	# lista = list(sentiment_vector.keys())
	# pickle.dump(lista, open('../sentiment_features', 'wb'))
...
# get_temporal_features_vector_only_twts(pickle.load(open('../tweets','rb')))
